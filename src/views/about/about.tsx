        ...
        <section id={props.sectionId}>
            <div className="section-container">
                ...
                <div className="section-content">
                    ...
                    <p>Somos un restaurant de comida tradicional Turca, nos caracterizamos por el sabor natural y fresco de la carne, que es preparada cada día en nuestra cocina.</p>
                </div>
